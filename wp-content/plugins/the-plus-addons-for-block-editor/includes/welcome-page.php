		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('18 March 2024','tpgb').' <span class="changelog-version">'.esc_html__('3.2.8','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Added : Number Counter : Numeration Option','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Progress Tracker : Pin Point Option and It Will Connect To Container Or Any Unique Id.','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Plugin Deactivate : QUICK FEEDBACK Popup Added','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Info Box : Carousel Layout Default Button CSS Load Bug Fix.','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Social Feeds : Multi-Bytes Bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Social Reviews : Multi-Bytes Bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Full Site Editor : Global Color and Typography CSS Loading Bug Fixed','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Plus Core Blocks : Preview Device JS Bug Fixed','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : CSS & JS : Fix for Loading HTTP or HTTPS URLs Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Component : Range Field Unit Change Bug Fixed','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Post Meta : Post Reading Time Bug Fixed','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				echo '<div class="tpgb-changelog-list">';
